import { EXT2BlockGroup } from "@/app/ext2/(ext2-parts)/components/graphic/ext2-block-group";
import {
  GlobalState,
...
export function EXT2Settings() {
  ...
  const onColorChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    dispatch(
      setEXT2BlockGroupComponentColor({
        id: selectedComponent as keyof GlobalState["settings"]["ext2"],
              ...
              <input
                ...
                value={
                  EXT2BlockGroupComponentColors !== undefined
                    ? (EXT2BlockGroupComponentColors as any)[
                        selectedComponent
                      ]
                    : "#ffffff"
                }
