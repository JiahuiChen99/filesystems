...
export const inodeData: EXT2.Struct[] = [
    ...
    info: (
      <>
        ...
        <Table>
          ...
          <TableBody>
            {imodeData.map((imode) => (
              <TableRow key={imode.id}>
                <TableCell className="font-medium">{imode.name}</TableCell>
                <TableCell>{imode.value}</TableCell>
                <TableCell>{imode.description}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
  ...
  },
  {
    ...
    size: 2,
    description: "i_gid",
    info: <p>16bit value of the POSIX group having access to this file.</p>,
  },
  {
    id: "i_links_count",
    offset: 26,
    ...
    info: (
      <>
        <p>
          ...
          contained in the <a href="/ext-2/inode-table#i_block">i_block</a>
          &nbsp; array.
        </p>
        <p>
  ...
  },
  {
    ...
    info: (
      <>
        <p>
          32bit value indicating how the ext-2 implementation should behave when
        ...
        <Table>
          ...
          <TableBody>
            {iflagsData.map((iflag) => (
              <TableRow key={iflag.id}>
                <TableCell className="font-medium">{iflag.name}</TableCell>
                <TableCell>{iflag.value}</TableCell>
                <TableCell>{iflag.description}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
  ...
  },
  {
    ...
    info: <p>32bit value used to indicate the file version (used by NFS).</p>,
  },
  {
    id: "i_file_acl",
    offset: 104,
    ...
    info: (
      <>
        ...
        <q>
          ...
          <a href="/ext-2/inode-table#i_osd2">i_osd2</a>
          structure.
        </q>
      </>
    ),
