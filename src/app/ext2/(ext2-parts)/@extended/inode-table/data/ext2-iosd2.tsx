import { EXT2 } from "@/app/ext2/types/ext2";
...
export const iosd2HurdData: EXT2.Struct[] = [
  ...
  },
  {
    ...
    info: (
      <p>
        High 16bit of <a href="/ext2/inode-table#i_uid">user_id</a>.
      </p>
    ),
  },
  {
    ...
    info: (
      <p>
        High 16bit of <a href="/ext2/inode-table#i_gid">group_id</a>.
      </p>
    ),
  },
  {
    ...
    info: (
      <p>
        ...
        the POSIX <a href="/ext2/inode-table#i_uid">user_id</a> will be used.
      </p>
    ),
  },
];
